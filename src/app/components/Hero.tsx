        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="text-sm font-mono text-[#22D3EE]">
              Pioneering AI-Enhanced Educational Gaming
            </span>
          </motion.div>
          ...
          >
            Where <span className="text-[#6366F1]">AI</span>,{" "}
            <span className="text-[#22D3EE]">Gaming</span>, and{" "}
          ...
          >
            Experience our cutting-edge mini-games powered by AI. Enhance your
            skills, track your progress, and revolutionize your learning
            journey.
          </motion.p>
          ...
          >
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">
                Adaptive learning paths enhanced by advanced AI algorithms
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">
                Engaging educational games designed for optimal learning
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
          ...
          >
            <Link href="/mini-games">
              <Button variant="default">Try Mini-Games</Button>
            </Link>
