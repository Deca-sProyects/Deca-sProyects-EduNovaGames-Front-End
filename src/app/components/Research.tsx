...
const studies = [
  {
    ...
    year: "2023",
    highlight:
      "47% improvement in knowledge retention through gamified learning",
    icon: Brain,
    color: "#6366F1",
  },
  {
    ...
    year: "2023",
    highlight:
      "83% of students showed improved engagement with AI-powered systems",
    icon: Lightbulb,
    color: "#22D3EE",
  },
  {
    ...
    year: "2023",
    highlight:
      "92% of institutions report positive ROI from educational gaming",
    icon: FileText,
    color: "#FF3B9A",
  },
];
